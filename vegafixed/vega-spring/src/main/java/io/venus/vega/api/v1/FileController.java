...
import io.venus.vega.api.v1.resources.FileDownloadRequestResource;
import io.venus.vega.api.v1.resources.FileListResource;
import io.venus.vega.services.FileService;
...
public class FileController extends AbstractController implements FilesApi {
    ...
    public ResponseEntity<Resource> downloadFile(String  filePath) {
        final var downloadFileDto = this.fileService.downloadFile(filePath);
